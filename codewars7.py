...
s='0000000011011010011100000110000001111110100111110011111100000000000111011111111011111011111000000101100011111100000111110011101100000100000'
s1=s.split('00000000000')
print(s1)
s2=''
for i in s1:
    a1=i.split('00000')
